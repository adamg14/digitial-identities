...
export default function RegisterPage() {
  ...
  if (isSuccess) {
    return (
      <div className="container mx-auto px-4 py-8">
        <Alert className="bg-green-900 border-green-700 text-green-100 max-w-md mx-auto">
          <CheckCircle2 className="h-4 w-4" />
          <AlertTitle>Registration Successful!</AlertTitle>
          <AlertDescription>Your identity has been successfully registered on the blockchain.</AlertDescription>
        </Alert>
        <Button onClick={resetForm} className="mt-4 bg-indigo-600 hover:bg-indigo-700 text-white mx-auto block">
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold text-center mb-8 text-gray-100">Register Your Identity</h1>
      <Card className="bg-gray-800/50 backdrop-blur-md border-gray-700 max-w-md mx-auto">
        <CardHeader>
          <CardTitle className="text-gray-100">Registration Form</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="documentId" className="text-gray-300">
                Document ID
              </Label>
              <Input
                id="documentId"
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                {profilePicture && <span className="text-gray-100 text-sm truncate">{profilePicture.name}</span>}
              </div>
            </div>
            <div className="space-y-2">
